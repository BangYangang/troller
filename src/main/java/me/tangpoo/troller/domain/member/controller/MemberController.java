...
public class MemberController {
    ...
    @GetMapping
    public ResponseEntity<MemberResponse> getMember(@AuthenticationPrincipal UserDetailsImpl userDetails){
        return new ResponseEntity<>(memberService.getMember(userDetails.getMember().getMemberId()), HttpStatus.OK);
    }
